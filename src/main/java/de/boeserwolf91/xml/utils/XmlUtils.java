...
{
    private static XMLEvent EOL;
    private static XMLEvent TAB;

    private XmlUtils() {}

    private static void initXmlUtils(XMLEventFactory eventFactory)
    {
        if (EOL == null)
        {
            EOL = eventFactory.createDTD("\n");
        }
        if (TAB == null)
        {
     ...
     *          is thrown if an error occurred by writing or creating a xml element
     */
    public static void createTextElement(XMLEventWriter eventWriter, XMLEventFactory eventFactory, int hierarchy, String name, String text, Attribute... attributes) throws XMLStreamException
    {
        initXmlUtils(eventFactory);
     ...
     */
    public static void createStartElement(XMLEventWriter eventWriter, XMLEventFactory eventFactory, int hierarchy, String name, Attribute... attributes) throws XMLStreamException
    {
        initXmlUtils(eventFactory);
        for (int i = 0; i < hierarchy; i++)
        {
     ...
     * @throws XMLStreamException is thrown if an error occurred by writing or creating a xml element
     */
    public static void createEndElement(XMLEventWriter eventWriter, XMLEventFactory eventFactory, int hierarchy, String name) throws XMLStreamException
    {
        initXmlUtils(eventFactory);
     ...
     * @throws XMLStreamException is thrown if an error occurred by writing or creating a xml element
     */
    public static void createSimpleComment(XMLEventWriter eventWriter, XMLEventFactory eventFactory, int hierarchy, String comment) throws XMLStreamException
    {
        initXmlUtils(eventFactory);
     ...
     * @throws XMLStreamException is thrown if an error occurred by writing or creating a xml element
     */
    public static void createMultilineComment(XMLEventWriter eventWriter, XMLEventFactory eventFactory, int hierarchy, int charsPerLine, String comment) throws XMLStreamException
    {
        initXmlUtils(eventFactory);
     ...
     * @throws XMLStreamException is thrown if an error occurred by writing or creating a xml element
     */
    public static void createCharacaters(XMLEventWriter eventWriter, XMLEventFactory eventFactory, int hierarchy, String text) throws XMLStreamException
    {
        for (int i = 0; i < hierarchy; i++)
        {
            eventWriter.add(TAB);
